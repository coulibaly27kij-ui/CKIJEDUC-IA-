...
export default async function handler(req, res) {
  // Gestion du CORS pour permettre à ton site d'appeler l'API
  ...
  // Récupération de la clé secrète stockée sur Vercel
  ...
  try {
    ...
    // Consignes strictes pour limiter l'IA au programme et domaine de CKIJEDUC
